...
<section class="service-banner" style="background-image: url('<?php echo esc_url($banner_image['url']); ?>');">
            ...
            <div class="banner-content">
                ...
                <div class="breadcrumbs">
                    <?php
                        // Breadcrumbs - a simple version, can be replaced with a plugin function
            ...
            <div class="service-content-main">
                ...
                <section class="cta-section">
                    <div class="cta-content">
                        <h3>מוכנים להתחיל?</h3>
                        <p>לחצו כאן כדי ליצור איתנו קשר ולקבל פרטים נוספים על השירותים שלנו.</p>
                        <a href="#contact-form-section" class="cta-button pulse-effect">צרו קשר עכשיו</a>
                    </div>
                </section>
            </div>
                        ...
                        <?php
                            ...
                            if ( $other_services_query->have_posts() ) :
                                while ( $other_services_query->have_posts() ) : $other_services_query->the_post();
                                    // Get the banner image for the sidebar thumbnail if available
